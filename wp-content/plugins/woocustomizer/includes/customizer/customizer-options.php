...
function woocustomizer_customizer_library_options()
{
    ...
    if ( WooCustomizer::wcz_is_plugin_active( 'woocommerce.php' ) ) {
        ...
        //     $options['wcz-heading-sticart'] = array(
        //         'id' => 'wcz-heading-sticart',
        //         'label'   => __( 'Sticky Cart', 'woocustomizer' ),
        //         'section' => $section,
        //         'type'    => 'url',
        //     );
        //     $choices = array( // Edit/Remove Description Tab
        //         'none' => 'None',
        //         'wcz-sticart-top' => 'Top Sticky Cart',
        //         'wcz-sticart-bottom' => 'Bottom Sticky Cart',
        //     );
        //     $options['wcz-sticart-layout'] = array(
        //         'id' => 'wcz-sticart-layout',
