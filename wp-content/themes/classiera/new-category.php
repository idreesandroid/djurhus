...
$the_cateogry = get_the_category();

echo "<pre>";
print_r($the_cateogry);
echo "</pre>";
...
<nav aria-label="breadcrumb">
   <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page"><?php echo $the_cateogry[0]->name; ?></li>
   </ol>
</nav>
            ...
            <div class="sidebar-box">
               ...
               <div class="sidebar-section-body">
                  <div class="form-group input-group icon-group">
                     <input type="text" class="form-control filter-intput" placeholder="<?php echo isset($_POST['search_term'])?$_POST['search_term']:'Product Name'; ?>" name="search_term">
               ...
               <div class="sidebar-section-body">
                  <div class="pricing widget-item">
                     <div class="slider slider-horizontal" id="">
                        ...
                        <div class="slider-handle max-slider-handle round" role="slider" aria-valuemin="0" aria-valuemax="21000" aria-valuenow="21000" aria-valuetext="undefined - undefined" tabindex="0" style="left: 100%;"></div>
                     </div>
                     ...
                     <div class="price-info">
                        <span>from</span>
                        <input type="text" id="min_price" placeholder="0" readonly="" value="0">
                        <span>to</span>
                        <input type="text" id="max_price" placeholder="21000.00" readonly="" value="21000">
                        <button type="submit" class="btn-price filterbtn filter-intput" >Filter</button>
                     </div>
                  </div>
               </div> -->
            ...
            <div class="row">
                ...
                if(isset($_POST['search_term']) &&  $_POST['search_term'] != ''){
                 ...
                 $args = array(
                   ...
                   //echo "check post method only";
                   $args = array(
                        'post_type' => 'product',
                        'product_cat' => $the_cateogry[0]->slug,
                        'post_status' => 'publish',
                        'orderby'  => 'date'
                    ); 
                }
