						...
						<div class="form-inline row">
							...
							<div class="form-group col-sm-6">
                                ...
                                <div class="inner-addon left-addon">
                                    ...
                                    <input id="humanTest" type="text" name="humanTest" class="form-control form-control-md" placeholder="<?php esc_attr_e('Your Answer', 'classiera'); ?>" data-error="<?php esc_attr_e( 'Security Answer Requried', 'classiera' ); ?>" required>
                                    <div class="help-block with-errors"></div>
