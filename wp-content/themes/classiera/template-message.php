...
<section class="user-pages section-gray-bg">
	<div class="container">
		<iframe src="https://djurhus.se/laravelchat/public/chat?user_info=<?php echo $user_id ?>&user_name='<?php echo $user_info->display_name; ?>'" width="100%" border="0" style="height: calc(86vh - 50px); border: 0;"></iframe>
	</div>
</section>
<!-- End new design -->

<section class="user-pages section-gray-bg hidden">
	<div class="container">
        <div class="row">
