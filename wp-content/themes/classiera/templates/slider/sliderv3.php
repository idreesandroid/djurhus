						...
						<div class="form-v6-bg">
							...
							<div class="form-group classieraAjaxInput">
								<div class="input-group inner-addon left-addon">
									...
									<input type="text" id="classieraSearchAJax" name="s" class="form-control form-control-lg" placeholder="<?php esc_attr_e( 'Enter title or keyword...', 'classiera' ); ?>" data-error="<?php esc_attr_e( 'Please Type some words..!', 'classiera' ); ?>">
							...
							<div class="form-group">
								<button type="submit" name="search" value="<?php esc_attr_e( 'Finds Ads', 'classiera' ); ?>"><?php esc_html_e( 'Find Ads', 'classiera' ); ?></button>
							</div><!--form-group-->
						</div><!--form-v6-bg-->
					</form>
				</div><!--col-md-12-->
