						...
						<div class="form-v6-bg">
							...
							<div class="form-group classieraAjaxInput">
								<div class="input-group inner-addon left-addon">
									...
									<input type="text" id="classieraSearchAJax" name="s" class="form-control form-control-lg" placeholder="<?php esc_attr_e( 'Enter keyword...', 'classiera' ); ?>" data-error="<?php esc_attr_e( 'Please Type some words..!', 'classiera' ); ?>">
